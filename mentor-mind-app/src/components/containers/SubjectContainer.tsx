            ...
            <Stack
                ...
                <Box sx={{
                ...
                }}>
                    {
                        ...
                        (subject?.id ?? 0) % 3 != 1
                            ? <img src={ComputerIcon} alt={subject.icon.toString()} style={{ maxHeight: '100%', maxWidth: '100%' }} />
                            : <img src={NotebookIcon} alt={subject.icon.toString()} style={{ maxHeight: '100%', maxWidth: '100%' }} />
                    }
                </Box>
                {
                    progress > 0
